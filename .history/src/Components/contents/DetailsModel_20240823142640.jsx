                    ...
                    <div className="text-black dark:text-white text-base lg:text-lg font-normal py-2 px-2 md:px-2 lg:px-3">
                      <ul className="grid grid-cols-3 justify-between p-0 m-0">
                          ...
                          <li>
                            ...
                            <span className="text-sm">الشارع:</span>{data?.street}
                          </li>
                          ...
                          <li>
                            <MdHolidayVillage className="inline-block mx-1 md:mx-0.5 w-5 text-black" />
                            <span className="text-sm">عدد الصالات:</span>{data?.hall}
                          </li>
                          <li>
                            <MdHolidayVillage className="inline-block mx-1 md:mx-0.5 w-5 text-black" />
                            <span className="text-sm">غرفه خادمه:</span>{data?.maid}
                          </li>
                          <li>
                            <MdHolidayVillage className="inline-block mx-1 md:mx-0.5 w-5 text-black" />
                            <span className="text-sm">غرفه حارس:</span>{data?.warehouse}
                          </li>
                          <li>
                            <MdHolidayVillage className="inline-block mx-1 md:mx-0.5 w-5 text-black" />
                            <span className="text-sm">غرفه حارس:</span>{data?.driver}
                          </li>
