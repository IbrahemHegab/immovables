  ...
  return (
    <section className="my-8">
      <div className="md:container px-4 m-auto">
        ...
        <Dropdown color={"warning"} label="النوع" dismissOnClick={false}>
      <Dropdown.Item>شقه</Dropdown.Item>
      <Dropdown.Item>فيلا</Dropdown.Item>
    </Dropdown>
    <Dropdown color={"warning"} label="عدد الغرف" dismissOnClick={false}>
      <Dropdown.Item>Dashboard</Dropdown.Item>
      <Dropdown.Item>Settings</Dropdown.Item>
      <Dropdown.Item>Earnings</Dropdown.Item>
      <Dropdown.Item>Sign out</Dropdown.Item>
    </Dropdown>
    <Dropdown color={"warning"} label="المساحه" dismissOnClick={false}>
      <Dropdown.Item>Dashboard</Dropdown.Item>
      <Dropdown.Item>Settings</Dropdown.Item>
      <Dropdown.Item>Earnings</Dropdown.Item>
      <Dropdown.Item>Sign out</Dropdown.Item>
    </Dropdown>
    <div><div class=""><label class="block"><span class="block mb-1.5 text-lg text-secondary-700 dark:text-secondary-400 font-ge-dinar-medium">السعر من</span><span class="p-inputnumber p-component p-inputwrapper p-inputnumber-buttons-stacked w-full md:w-14rem" showclear="">
      <input class="p-inputtext p-component p-inputnumber-input" id="stacked-buttons" role="spinbutton" aria-valuemin="0" placeholder="أقل السعر" value="" /><span class="p-inputnumber-button-group"><button class="p-button p-component p-button-icon-only p-inputnumber-button p-inputnumber-button-up" type="button" tabindex="-1" aria-hidden="true"><span class="pi pi-angle-up p-button-icon"></span><span class="p-button-label">&nbsp;</span></button><button class="p-button p-component p-button-icon-only p-inputnumber-button p-inputnumber-button-down p-disabled" type="button" tabindex="-1" aria-hidden="true">
      <span class="pi pi-angle-down p-button-icon"></span><span class="p-button-label">&nbsp;</span></button></span></span></label></div></div>
        </div>
