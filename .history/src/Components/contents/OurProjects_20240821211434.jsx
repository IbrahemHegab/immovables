      ...
      <div className="md:container px-4 m-auto">
        ...
        <div className="flex items-center gap-3 justify-center pb-5 lg:pb-6">
          ...
          <div>
            <div class="">
              <label class="block">
                <span class="block mb-1.5 text-lg text-secondary-700 dark:text-secondary-400 font-ge-dinar-medium">
                  السعر من
                </span>
                <span
                  class="p-inputnumber p-component p-inputwrapper p-inputnumber-buttons-stacked w-full md:w-14rem"
                  showclear=""
                >
                  <input
                    ...
                    role="spinbutton"
                    aria-valuemin="0"
                    placeholder="أقل السعر"
                    value=""
                  />
                  <span class="p-inputnumber-button-group">
                    <button
                      class="p-button p-component p-button-icon-only p-inputnumber-button p-inputnumber-button-up"
                      type="button"
                      tabindex="-1"
                      aria-hidden="true"
                    >
                    ...
                    <button
                      class="p-button p-component p-button-icon-only p-inputnumber-button p-inputnumber-button-down p-disabled"
                      type="button"
                      tabindex="-1"
                      aria-hidden="true"
                    >
