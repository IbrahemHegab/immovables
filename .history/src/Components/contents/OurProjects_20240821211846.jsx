...
const OurProjects = () => {
  return (
    ...
    <Dropdown color={"transparent"} label="عدد الغرف" dismissOnClick={false} className="border-2 border-indigo-600">
    ...
    <Dropdown color={"warning"} label="المساحه" dismissOnClick={false}>
      ...
      <Dropdown.Item>Sign out</Dropdown.Item>
          ...
          <input type="number" className="border rounded-lg" placeholder="السعر اقل من؟"/>
          <input type="number" className="border rounded-lg" placeholder="السعر اكبر من؟"/>
