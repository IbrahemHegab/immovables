            ...
            <div className="relative">
              <div className="leading-7 bg-white dark:bg-black shadow-md cursor-pointer overflow-hidden rounded-tl-lg rounded-tr-lg">
                ...
                <div className="flex flex-col justify-between h-full">
                    ...
                    <ul className="flex justify-between p-0 m-0">
                      <div>
                        ...
                        <li>
                          ...
                          <span className="text-sm">مطبخ:</span>2
                        </li>
                      </div>
                      <div>
                        <li>
                          <MdMeetingRoom className="inline-block mx-1 md:mx-0.5 w-5 text-black" />
                          <span className="text-sm">عدد الغرف:</span>3
                        </li>
                        <li>
                  ...
                  <span className="w-full block text-light text-center bg-yellow-500 py-2 text-sm xl:text-base hover:bg-primary-300">
                    إضغط لتفاصيل أكثر
                  </span>
                </div>
              </div>
