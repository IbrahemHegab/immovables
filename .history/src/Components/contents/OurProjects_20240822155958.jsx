...
{data.length > 0 && data ? (data.map((e)=>(<div key={e._id}>
                    ...
                    <ul className="flex justify-between p-0 m-0">
                      <div>
                        ...
                        <li>
                          ...
                          <span className="text-sm">مطبخ:</span>{e.kitchen}
                        </li>
                      </div>
                      <div>
                        <li>
                          <MdMeetingRoom className="inline-block mx-1 md:mx-0.5 w-5 text-black" />
                          <span className="text-sm">عدد الغرف:</span>{e.rooms}
                        </li>
                        <li>
