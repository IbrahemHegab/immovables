...
const OurProjects = () => {
  ...
  const [selectedArea, setSelectedJHall] = useState(""); // لتخزين المساحة المختارة
  ...
  const filteredData = data.filter((e) => {
    return (
      ...
      (!selectedArea || e.area === Number(selectedArea))
    );
  });
        ...
        <div className="grid lg:grid-cols-5 grid-cols-2 sm:grid-cols-2 gap-3 justify-center pb-5 lg:pb-6">
          <div className="border rounded-lg border-gray-400">
            ...
            >
              ...
              <Dropdown.Item onClick={() => setSelectedType("villa")}>
                فيلا
              </Dropdown.Item>
            </Dropdown>
          </div>
          ...
          <div className="border rounded-lg border-gray-400">
            <Dropdown
              ...
              dismissOnClick={false}
            >
              <Dropdown.Item onClick={() => setSelectedArea("1000")}>
                1000
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSelectedArea("1200")}>
                1200
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSelectedArea("1300")}>
                1300
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSelectedArea("1400")}>
                1400
              </Dropdown.Item>
            </Dropdown>
          </div>
