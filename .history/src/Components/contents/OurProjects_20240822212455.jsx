        ...
        <div className="grid lg:grid-cols-5 grid-cols-2 sm:grid-cols-2 gap-3 justify-center pb-5 lg:pb-6">
          <div className="border rounded-lg border-gray-400">
            ...
            >
              ...
              <Dropdown.Item onClick={() => setSelectedType("villa-200-295" || "villa-300-450")}>
                فيلا
              </Dropdown.Item>
            </Dropdown>
          </div>
          ...
          <div className="border rounded-lg border-gray-400">
            <Dropdown
              ...
              dismissOnClick={false}
            >
              <Dropdown.Item onClick={() => setSelectedHall("1000")}>
                1
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSelectedHall("1200")}>
                2
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSelectedHall("1300")}>
                3
              </Dropdown.Item>
              <Dropdown.Item onClick={() => setSelectedHall("1400")}>
                4
              </Dropdown.Item>
            </Dropdown>
          </div>
