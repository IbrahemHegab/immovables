...
const OurProjects = () => {
  ...
  const [details, setDetaild] = useState(null); // لتخزين نوع العقار المختار
                  ...
                  <div className="relative">
                    <div className="leading-7 bg-white dark:bg-black shadow-md cursor-pointer overflow-hidden rounded-tl-lg rounded-tr-lg">
                      ...
                      <div className="flex flex-col justify-between h-full">
                        ...
                        <span  onClick={(()=>{setDetaild(e)})} className="w-full block text-white text-center bg-yellow-500 py-2 text-sm xl:text-base hover:bg-primary-300">
                          إضغط لتفاصيل أكثر
                        </span>
                      </div>
                    </div>
