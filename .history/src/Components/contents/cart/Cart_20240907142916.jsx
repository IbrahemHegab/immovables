  ...
  return (
    <div className="p-4">
      <div className="flex justify-between">
        <h2 className="text-2xl font-bold mb-4">سلة الوحدات المفضلة <FaCartArrowDown />
        </h2>
        <h5 className=" font-bold mb-4">اجمالي سعر الوحدات:2400 ريال</h5>
      </div>
        ...
        {products.map((product) => (
          <div key={product.id} className="border rounded-lg p-4 shadow-md">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <FaHeart size={"30px"} className="text-red-500 cursor-pointer hover:text-black" />
            </div>
