  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-4 gap-5 ">
        <div
          className="p-2 bg-yellow-700 rounded-xl text-center cursor-pointer hover:bg-ye"
          onClick={() => setFilter("all")}
        >
          <span>عرض الكل</span>
        </div>
        <div
          className="p-2 bg-yellow-700 hover:bg-yellow-500 rounded-xl text-center cursor-pointer hover:bg-ye"
