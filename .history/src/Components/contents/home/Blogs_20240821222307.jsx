            ...
            <SwiperSlide>
              ...
              >
                <div className="bg-white shadow-lg dark:bg-black rounded-lg overflow-hidden mx-4 w-full h-full">
                  ...
                  <يهر className="h-100 overflow-hidden mx-0 mt-0 mb-4 py-2 px-3 text-lg text-left rtl:text-right leading-8 text-black dark:text-white font-ge-dinar-medium">
                    <a href="#/18" className="block">
                      فيلا الموافقة
                    </a>
                  </ي>
