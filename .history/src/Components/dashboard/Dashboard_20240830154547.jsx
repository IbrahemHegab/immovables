          ...
          <div className="flex items-center justify-between md:mx-5">
            <div className="flex items-center justify-start rtl:justify-end">
              <button
                ...
                className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              >
