          ...
          <div className="flex items-center justify-between md:mx-5">
            <div className="flex items-center justify-start rtl:justify-end">
              <button
                ...
                className=" items-center p-2 text-sm text-gray-500 rounded-lg sm:b block hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              >
