            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                ...
                <div className="flex relative">
                  ...
                  <span
                    className={`absolute top-0  ${user?.notifications.length ===0 ?"bg-green-600":"bg-green-600"} rounded-full w-5 h-5 text-gray-50 flex items-center justify-center text-xs`}
                    style={{ right: "10px" }}
                  >
