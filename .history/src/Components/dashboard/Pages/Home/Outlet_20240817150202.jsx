...
const OutletDashboard = () => {
  ...
  return (
    <div className="grid lg:grid-cols-11 overflow-scroll grid-flow-col gap-4 ">
      <div
        className={`lg:col-span-2 sm:col-span-10 lg:block md:block xl:block lg:static xl:static  fixed z-10 ${
          SideBar ? "hidden" : ""
        }`}
      >
        <Aside />
      </div>
      <div className="col-span-12 lg:col-span-10 mt-16 md:col-span-auto  text-gray-50 h-screen ">
        {" "}
        <Outlet />
      </div>
      <CreateModalCustomer />
