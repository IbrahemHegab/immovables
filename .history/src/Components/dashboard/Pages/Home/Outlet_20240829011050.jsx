...
const OutletDashboard = () => {
  ...
  return (
    <div className="grid lg:grid-cols-12 overflow-scroll  gap-1 ">
      <div
        className={`lg:col-span-2 sm:col-span-10 lg:block md:block xl:block lg:static xl:static   z-10 ${
          SideBar ? "hidden" : ""
        }`}
      >
        <Aside />
      </div>
      <div className="col-span-10  mt-16   text-gray-50 h-screen ">
        {" "}
        <Outlet />
      </div>
      <CreateModalCustomer />
