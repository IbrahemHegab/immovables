...
const OutletDashboard = () => {
  ...
  return (
    <div className="grid grid-cols-12 overflow-scroll grid-flow-col gap-1 ">
      <div
        className={`xl:col-span-2 lg:col-span-2 sm:col-span-10 lg:block md:block xl:block lg:static xlg:static   z-10 ${
          SideBar ? "hidden" : ""
        }`}
      >
        <Aside />
      </div>
      <div className="xl:col-span-10 lg:col-span-11 col-span-12 mt-16   text-gray-50 h-screen ">
        {" "}
        <Outlet />
      </div>
      <CreateModalCustomer />
