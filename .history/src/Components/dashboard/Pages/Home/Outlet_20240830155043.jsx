...
const OutletDashboard = () => {
  ...
  return (
    ...
    <div className="xl:col-span-10 lg:col-span-10 md:col-span-9 col-span-12 mt-16 text-gray-50 overflow-auto h-screen sm:bg-black xs md:bg-blue-600 lg:bg-red-600 xl:bg-green-500">
      <Outlet />
    </div>
