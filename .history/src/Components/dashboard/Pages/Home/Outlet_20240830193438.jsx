...
const OutletDashboard = () => {
  return (
    <div
      className="grid grid-cols-12 gap-2 overflow-hidden"
      style={{ height: "100vh" }}
    >
      <Aside />

      <div className="xl:col-span-11 lg:col-span-11 md:col-span-9 col-span-12 mt-20 text-gray-50 overflow-auto h-screen ">
        <Outlet />
      </div>
