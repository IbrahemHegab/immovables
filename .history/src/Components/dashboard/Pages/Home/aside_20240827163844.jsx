      ...
      <Sidebar.Items className="mt-16">
        <Sidebar.ItemGroup>
          ...
          >
              ...
              <Sidebar.Item to="/dashboard/customer" as={NavLink} icon={HiUser}>ادارة العملاء</Sidebar.Item>
          ...
          >
              ...
              <Sidebar.Item as={NavLink} to="gallery" className="bg-gray-200">اداره الوحدات</Sidebar.Item>
          ...
          >
              ...
              <Sidebar.Item className="bg-gray-200" as={NavLink} to="permisstion">اداره الصلاحيات</Sidebar.Item>
