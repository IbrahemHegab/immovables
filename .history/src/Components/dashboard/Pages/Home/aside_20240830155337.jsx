...
const Aside = () => {
  ...
  return (
    <div
      className={`xl:col-span-2 lg:col-span-2 md:col-span-3 xl:static lg:static md:static jhidden ${
        !SideBar ? "sm:hidden md:block" : "fixed lg:static md:static"
      }  z-10 col-span-10 bg-gray-900 h-screen`}
    >
      {" "}
      <Sidebar
