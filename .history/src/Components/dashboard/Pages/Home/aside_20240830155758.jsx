...
const Aside = () => {
  ...
  return (
    <div
    className={`xl:col-span-2 lg:col-span-2 md:col-span-3 col-span-10 bg-gray-900 z-10 ${
      !SideBar
        ? "sm:hidden md:block" // إخفاء على الشاشات الصغيرة وإظهار على الشاشات المتوسطة
        : "fixed top-0 left-0 w-full h-full" // جعل الشريط الجانبي ثابتًا وممتدًا على كامل الشاشة
    } xl:static lg:static md:static`} // الوضع الثابت على الشاشات الكبيرة
  >
      {" "}
      <Sidebar
