          ...
          <Sidebar.ItemGroup>
            ...
            >
              ...
              <NavLink
                ...
                className="grid grid-cols-2 col-span-2 py-2 content-center cursor-pointer bg-gray-200 text-center items-center rounded-lg"
              >
                <span className="grid  ">فيلا 200-295</span>
                <span
                  className="m-auto"
                  onClick={() =>
                    dispatch(
