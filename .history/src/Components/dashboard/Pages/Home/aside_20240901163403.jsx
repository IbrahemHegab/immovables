...
{auth.user?.role !== "marketer" &&( <Sidebar.Item
                icon={FaPlus}
            ...
            <Sidebar.Collapse
              ...
              className="bg-gray-300"
            >
              {auth.user?.role !=="marketer" && ( <NavLink
                to="employees"
...
{auth.user?.role !=="marketer" && ( <Sidebar.Collapse
              icon={HiInbox}
              label="الكتالوج"
              className="bg-gray-300"
            >
            ...
            {auth.user?.role !== "supervisor" || auth.user?.role !== "marketer" && (
              <Sidebar.Collapse
                icon={HiTable}
                label="الخزنه"
                className="bg-gray-300"
