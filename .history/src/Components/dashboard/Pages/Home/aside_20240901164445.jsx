          ...
          <Sidebar.ItemGroup>
            ...
            >
              {auth.user?.role !== "marketer" && (
                <NavLink
                  to="employees"
                  className="grid grid-cols-1 py-2 content-center cursor-pointer bg-gray-200 text-start items-center rounded-lg"
                >
                  ادارة الموظفين
                </NavLink>
              )}
              ...
              {auth.user?.role === "manager" && (
                <div
                  ...
                  className="grid  py-2 content-center cursor-pointer bg-gray-200 text-center items-center rounded-lg"
                >
