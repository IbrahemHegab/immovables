          ...
          <Sidebar.ItemGroup>
            ...
            >
              {auth.user?.role !== "marketer" && (
                <NavLink
                  to="employees"
                  className="grid grid-cols-1 p-2 content-center cursor-pointer bg-gray-200 text-start items-center rounded-lg"
                >
                  ادارة الموظفين
                </NavLink>
              )}
              ...
              {auth.user?.role === "manager" && (
                <div
                  ...
                  className="flex  p-2 content-center cursor-pointer bg-gray-200 text-center items-start rounded-lg"
                >
              ...
              <NavLink
                to="employees/myTask"
                className="grid  p-2 content-center cursor-pointer bg-gray-200 text-start items-center rounded-lg"
              >
                المهام
              </NavLink>
            </Sidebar.Collapse>
            ...
            {auth.user?.role === "manager" && (
              ...
              >
                ...
                <div
                  onClick={() => dispatch(setOpenPermissionModelModel({create: true}))}
