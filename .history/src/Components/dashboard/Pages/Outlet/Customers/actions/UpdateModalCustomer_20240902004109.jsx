...
const UpdateModalCustomer = () => {
  const  UpdateCustomerModel  = useSelector((state) => state.sharedStore.UpdateCustomerModel);
                    ...
                    {employees.data.length > 0 && employees.data ? (
                      employees.data.map((marketer, inx) => (
                        ...
                        >
                          <input
                            type="checkbox"
                            defaultChecked={selectedMarketers
                                .map((ele) => ele.name)
                                .includes(marketer.name)}
                            // defaultChecked={selectedMarketers.includes(
                            //   marketer.name
                            // )}
                            className="mr-2"
                          />
