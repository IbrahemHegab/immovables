...
const EmployeesTable = () => {
  ...
  const filteredTasks = useMemo(() => {
    const tasks = employees.data || []; // Assuming tasks come from employees.data

    if (auth.user?.role === "manager") {
      return tasks; // The manager sees all tasks
    }
    ...
    if (auth.user?.role === "supervisor") {
      return tasks.filter((e) => e?.role === "marketer");
    }
  ...
  }, [auth.token, dispatch, employees.data.length]);
