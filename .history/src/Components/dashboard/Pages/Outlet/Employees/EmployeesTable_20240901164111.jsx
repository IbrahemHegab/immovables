    ...
    <div className="overflow-x-scroll xl:w-auto lg:w-auto md:w-auto w-screen h-screen">
      <Table dir="rtl">
        <Table.Head className="text-start">
          ...
          {auth.user?.role === "manager" && ( <Table.HeadCell>الخصائص</Table.HeadCell>)}
          ...
          {employees.isLoading ? (
            ...
            filteredTasks.map((e) => (
              ...
              >
                ...
                {auth.user?.role === "manager" &&( <Table.Cell className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-1 gap-2">
                  <Button
