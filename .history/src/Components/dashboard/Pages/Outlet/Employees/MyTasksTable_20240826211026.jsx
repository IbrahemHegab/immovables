...
if (auth.user.data.role === "accountant") {
  return task.data.role="supervisor" && "marketer"

}
if (auth.user.data.role === "supervisor") {
  return task.data.role="marketer" 

}
if (auth.user.data.role === "marketer") {
  return null
