...
console.log(task.assignedTasks);

  const filterRole = () => {
    const filteredTasks = showAssignedTasks ? task.assignedTasks : task.data; // استخدام المهام المسندة إذا كانت showAssignedTasks تساوي true
