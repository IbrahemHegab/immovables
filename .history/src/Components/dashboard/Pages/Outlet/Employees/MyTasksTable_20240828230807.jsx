...
const TasksTable = () => {
  ...
  const getRowColor = (diffInDays, taskDuration) => {
    if (diffInDays >= taskDuration) {
      return "bg-green-500"; // لون مميز عند تطابق الفرق مع مدة المهمة
    }
    if (diffInDays <= taskDuration) {
      return "bg-red-500"; // لون مميز عند تطابق الفرق مع مدة المهمة
    }
    if (diffInDays === taskDuration) {
      return "bg-yellow-500"; // لون مميز عند تطابق الفرق مع مدة المهمة
    }
