          ...
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              <Table.Row
                ...
                key={e?._id}
              >
                <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white" style={{borderRadius:0}}>
                ...
                <Table.Cell className="bg-red-700" style={{borderRadius:0}}>{e?.status || "غير متوفر"}</Table.Cell>
                {/* <Table.Cell>
