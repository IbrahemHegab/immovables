          ...
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              ...
              >
                ...
                <Table.Cell className="p-0">{e?.taskDuration || 0}</Table.Cell>
                ...
                <Table.Cell className="p-0">{e?.taskNotes || "غير متوفر"}</Table.Cell>
                <Table.Cell className="p-0">{e?.image || "غير متوفر"}</Table.Cell>
                <Table.Cell className="bg-red-700 p-0" style={{ borderRadius: 0 }}>
