        ...
        <Table.Body className="divide-y text-center">
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              ...
              >
                <Table.Cell
                  className="whitespace-nowrap font-medium text-gray-900 dark:text-white p-2"
                  style={{ borderRadius: 0 }}
                >
                  {e?.taskName || "لا يوجد اسم"}
                </Table.Cell>
                <Table.Cell className="p-2">{e?.taskDuration || 0}</Table.Cell>
                ...
                <Table.Cell className="p-2">{e?.taskNotes || "غير متوفر"}</Table.Cell>
                <Table.Cell className="p-2">{e?.image || "غير متوفر"}</Table.Cell>
                <Table.Cell className="bg-red-700 p-2" style={{ borderRadius: 0 }}>
