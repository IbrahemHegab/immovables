          ...
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              ...
              >
                ...
                <Table.Cell className="">{e?.taskDuration || 0}</Table.Cell>
                ...
                <Table.Cell className="">{e?.taskNotes || "غير متوفر"}</Table.Cell>
                <Table.Cell className="">{e?.image || "غير متوفر"}</Table.Cell>
                <Table.Cell className="bg-red-700 " style={{ borderRadius: 0 }}>
