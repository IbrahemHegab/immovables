        ...
        <Table.Body className="divide-y text-center">
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              ...
              >
                <Table.Cell
                  className="whitespace-nowrap font-medium text-gray-900 dark:text-white lg"
                  style={{ borderRadius: 0 }}
                >
                  {e?.taskName || "لا يوجد اسم"}
                </Table.Cell>
                <Table.Cell className="lg">{e?.taskDuration || 0}</Table.Cell>
                <Table.Cell className="lg">
                ...
                <Table.Cell className="lg">{e?.taskNotes || "غير متوفر"}</Table.Cell>
                <Table.Cell className="lg">{e?.image || "غير متوفر"}</Table.Cell>
                <Table.Cell className="bg-red-700 lg" style={{ borderRadius: 0 }}>
