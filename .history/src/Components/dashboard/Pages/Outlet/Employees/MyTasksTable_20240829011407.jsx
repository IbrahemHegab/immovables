        ...
        <Table.Body className="divide-y text-center">
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              ...
              >
                <Table.Cell
                  className="whitespace-nowrap font-medium text-gray-900 dark:text-white lg:p-5 md:p-2 sm:-"
                  style={{ borderRadius: 0 }}
                >
                  {e?.taskName || "لا يوجد اسم"}
                </Table.Cell>
                <Table.Cell className="lg:p-5 md:p-2 sm:-">{e?.taskDuration || 0}</Table.Cell>
                <Table.Cell className="lg:p-5 md:p-2 sm:-">
                ...
                <Table.Cell className="lg:p-5 md:p-2 sm:-">{e?.taskNotes || "غير متوفر"}</Table.Cell>
                <Table.Cell className="lg:p-5 md:p-2 sm:-">{e?.image || "غير متوفر"}</Table.Cell>
                <Table.Cell className="bg-red-700 lg:p-5 md:p-2 sm:-" style={{ borderRadius: 0 }}>
