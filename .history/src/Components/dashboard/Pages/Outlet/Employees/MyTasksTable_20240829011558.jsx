          ...
          {task.isLoading ? (
            ...
            filteredData.map((e, index) => (
              ...
              >
                ...
                <Table.Cell className="lg:p-5 md:p-2 sm:p-0 p-1">{e?.taskDuration || 0}</Table.Cell>
                ...
                <Table.Cell className="lg:p-5 md:p-2 sm:p-0 p-1 col-span-full">{e?.taskNotes || "غير متوفر"}</Table.Cell>
                <Table.Cell className="lg:p-5 md:p-2 sm:p-0 p-1">{e?.image || "غير متوفر"}</Table.Cell>
                <Table.Cell className="bg-red-700 lg:p-5 md:p-2 sm:p-0 p-1" style={{ borderRadius: 0 }}>
