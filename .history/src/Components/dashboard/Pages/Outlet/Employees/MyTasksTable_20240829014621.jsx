...
const TasksTable = () => {
  ...
  return (
    <div className="overflow-x-scroll xl:w-auto lg:w-auto w-screen h-screen">
      <div className="grid lg:grid-cols-5 content-center grid-cols-2 gap-3 items-center py-2">
        ...
        <Button className="bg-red-500 col-span-2 lg:col-span-1" onClick={() => setFilter("rejected")}>
          المرفوضة
        </Button>
      </div>
      <Table dir="rtl">
