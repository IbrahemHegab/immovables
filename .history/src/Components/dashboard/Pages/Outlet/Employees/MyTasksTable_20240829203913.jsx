    ...
    <>
      ...
      >
        ...
        {auth.user.role !== "manager" && (
          <Button onClick={() => filters()}>المهام المسنده الي</Button>
        )}
        ...
        <Button className={`bg-red-500 ${auth.user.role !== "manager" ? "lg:grid-cols-6" : "lg:grid-cols-5"}`} onClick={() => setFilter("rejected")}>
          المرفوضة
        </Button>
      </div>{" "}
