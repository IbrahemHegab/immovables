            ...
            {task.isLoading ? (
              ...
              filteredData.map((e, index) => (
                ...
                {`فرق الأيام: ${dates[index]?.diffInDays} يوم`} */}
                  ...
                  <Table.Cell style={{ borderRadius: 0 }} className="grid grid-cols-3">
                 
                      {" "}
                      <button className="bg-red-500 col-span-2 p-2" size={"sm"} style={{fontSize:"10px"}}>
                        غير مكتملة
                      </button>
                      {/* <Button size={"sm"}>تعديل</Button> */}
                      <button className="bg-green-800 col-span-1 p-2" size={"sm"} style={{fontSize:"10px"}}>
                        مكتملة
                      </button>
