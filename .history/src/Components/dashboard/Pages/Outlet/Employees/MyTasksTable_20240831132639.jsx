            ...
            {task.isLoading ? (
              ...
              filteredData.map((e, index) => (
                ...
                {`فرق الأيام: ${dates[index]?.diffInDays} يوم`} */}
                  ...
                  <Table.Cell style={{ borderRadius: 0, padding: 0 }}>
                    <div className="grid xlg:grid-cols-2  grid-cols-2 gap-2">
                      {" "}
                      <Button className="bg-red-500 m-auto p-3" size={"xsm"}>
                        غير مكتملة
                      </Button>
                      {/* <Button size={"sm"}>تعديل</Button> */}
                      <Button className="bg-green-800 m-auto p-3" size={"xsm"}>
                        مكتملة
                      </Button>
                    </div>
                  </Table.Cell>
