                  ...
                  <Table.Cell style={{ borderRadius: 0, padding: "10px" }}>
                    <div className="grid  xl:grid-cols-3 lg:grid-cols-1 grid-cols-1 gap-2">
                      ...
                      <Button
                        ...
                        disabled={
                          e.status === "review" || e.status === "rejected" ||e.status === "fulfilled"
                            ? true
                            : false
                        }
                        size={"xsm"}
                      ...
                      <Button
                        disabled={e.status === "progressing" ||e.status === "fulfilled" ? true : false}
                      ...
                      <Tooltip content="تم اكتمال المهمة بنجاح" arrow={false}> <Button
                      disabled={e.status === "fulfilled" ? true : false}
