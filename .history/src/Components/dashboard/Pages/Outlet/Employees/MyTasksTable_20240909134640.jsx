...
import { setOpenNoteTaskModelUpdate, setTaskID } from "../../../../store/SharedStore";
const TasksTable = () => {
  ...
  const handleTaskStatus = (e) => {
    dispatch(setOpenNoteTaskModelUpdate({ data: id, status: true }))
                ...
                {`فرق الأيام: ${dates[index]?.diffInDays} يوم`} */}
                  ...
                  >
                    <div className="flex justify-between gap-2">
                      ...
                      <Tooltip content="تم التحقق من اكتمال المهمة بنجاح" arrow={false}>
                        <Button
                          disabled={e.status === "fulfilled" || e.status === "progressing"}
