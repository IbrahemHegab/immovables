...
const TasksTable = () => {
  ...
  const handleTaskStatus = (e) => {
    dispatch(setOpenNoteTaskModelUpdate({ data: e, status: true , dataType: "review"}));
  
  };
  const handleTaskRejected = (e) => {
    dispatch(setOpenNoteTaskModelUpdate({ data: e, status: true , dataType: "rejected"}));
  
  };
  const handleTaskFulfilled = (e) => {
    dispatch(setOpenNoteTaskModelUpdate({ data: e, status: true , dataType: "fulfilled"}));
  ...
  return (
    <div className="w-100">
      ...
      <div className="overflow-auto xl:w-auto lg:w-auto w-screen ">
        <Table dir="rtl">
            ...
            {task.isLoading ? (
              ...
              filteredData.map((e, index) => (
                ...
                {`فرق الأيام: ${dates[index]?.diffInDays} يوم`} */}
                  ...
                  <Table.Cell
                    style={{ borderRadius: "0", padding: "10px 15px" }}
                  >
                    <div className="flex justify-between gap-2">
                      ...
                      <Tooltip
                        content="تم التحقق من اكتمال المهمة بنجاح"
                        arrow={false}
                      >
                        <Button
                          disabled={
