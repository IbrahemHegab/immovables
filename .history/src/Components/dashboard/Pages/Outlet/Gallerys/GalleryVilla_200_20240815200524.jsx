...
const GalleryVilla_200 = () => {
  ...
  return (
    <div className="grid lg:grid-cols-3  sm:grid-cols-1 gap-3 ">
      ...
      {isOpen && (
        <Lightbox
          mainSrc={imageEle[photoIndex]}
          nextSrc={imageEle[(photoIndex + 1) % imageEle.length]}
          prevSrc={imageEle[(photoIndex + imageEle.length - 1) % images.length]}
