        ...
        data.map((e, index) => (
          <Card className="max-w-sm card-gallery bg-bla" key={e?._id}>
            ...
            <div className="grid grid-cols-3 content-around text-gray-900 text-center xl:mt-20 mt-20 md:mt-0">
              ...
              <div>
                <h6>غرفه سائق</h6>
                <small className="py2">{e?.driver ? "نعم" : "لا"}</small>
              </div>
              <div>
                <h6>البلكونه</h6>
...
{auth.user?.role === "manager" && (<div className="flex items-center justify-between p-5">
              <a
      ...
      {isOpen && (
        <div>
          ...
          <Modal show={isOpen} onClose={() => setIsOpen(false)}>
            ...
            />
            <Modal.Footer>
              <Button className="bg-red-600" onClick={() => setIsOpen(false)}>اغلاق</Button>
            </Modal.Footer>
          </Modal>
        </div>
      )}
