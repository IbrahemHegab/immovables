...
const CreateModalGallery = () => {
  // const galleryFormValid = Yup.object().shape({
  ...
  //   driver: Yup.boolean(),
  //   images: Yup.string().required( "يجب تحميل صورة واحدة على الأقل"),
  // });
  const initstate = {
    area: "",
    price: "",
  ...
  return (
    <Modal show={GalleryModel.status}>
      <Formik initialValues={initstate} onSubmit={submit} validationSchema={galleryFormValid} validateOnBlur={true}
