...
import { FormValid, galleryFormValid } from "../../../../../utils/FormValidation";
          ...
          <Form>
            ...
            <Modal.Body>
              <div className="grid grid-flow-row-dense lg:grid-cols-4 grid-cols-2 gap-3">
                ...
                {GalleryModel.data?.kind === "apartment" ? null : (
                  <> 
                       <div className="lg:col-auto col-span-2">
                  <div className="mb-2 block">
                ...
                <div className="col-span-4">
                  ...
                  <FileInput
                    ...
                    accept=".png, .jpg, .jpeg"
                    type="file"
                    helperText={`${GalleryModel.data?.kind === "apartment" ? "تحميل صوره شقه" :"تحميل صور الفيلا"}`}
                    multiple
