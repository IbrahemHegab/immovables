...
const UpdateModalGallery = () => {
  ...
  const [selectedValueStatus, setSelectedValue] = useState(
   
  );
  const [selectedValueKind, setSelectedValueKind] = useState(

  );
  console.log(UpdateGalleryModel.data?.kind);

  const submit = (values, { setSubmitting }) => {
    values.kind =     UpdateGalleryModel.data && UpdateGalleryModel.data.kind
    ? UpdateGalleryModel.data.kind
    : "apartment";
    values.status =  UpdateGalleryModel.data && UpdateGalleryModel.data.status
                      ...
                      <div className="grid grid-cols-2">
                        <div>
                          <Field
                            ...
                            value="true"
                            className="form-radio"
                            checked={initstate.warehouse === true}
                          />
                        ...
                        <div>
                          <Field
                            ...
                            value="false"
                            className="form-radio"
                            checked={initstate.warehouse === false}
                          />
                  ...
                  <div className="grid grid-cols-2">
                    <div>
                      <Field
                        ...
                        value="true"
                        className="form-radio"
                        checked={initstate.elevator === true}
                      />
                    ...
                    <div>
                      <Field
                        ...
                        value="false"
                        className="form-radio"
                        checked={initstate.elevator === false}
                      />
