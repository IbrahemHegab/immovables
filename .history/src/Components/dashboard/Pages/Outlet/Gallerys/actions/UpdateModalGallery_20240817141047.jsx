              ...
              <div className="grid grid-flow-row-dense lg:grid-cols-4 grid-cols-2 gap-3">
                ...
                <div className="col-span-1">
                  ...
                  <div className="flex justify-center text-center bg-gray-200 p-1 rounded-lg">
                    <Dropdown label={"الحاله"} inline>
                      <Dropdown.Item value={"available"}>متاح</Dropdown.Item>
                      <Dropdown.Item value={"pawned"}>محجوز</Dropdown.Item>
                      <Dropdown.Item value={"sold"}>مباع</Dropdown.Item>
                    </Dropdown>
                  </div>
                </div>
                <div className="lg:col-auto col-span-2">
