              ...
              <div className="grid grid-flow-row-dense lg:grid-cols-4 grid-cols-2 gap-3">
                ...
                <div className="col-span-1">
                  ...
                  <div className="flex justify-center text-center bg-gray-200 p-2 rounded-lg">
                    <Dropdown
                      label={selectedValueSt}
                      inline
                      onSelect={(e) => setFieldValue("status", e)}
                    >
                      <Dropdown.Item
                        onClick={() => setSelectedValueStatus("مدير")}
                      >
                        مدير
                      </Dropdown.Item>
                      <Dropdown.Item
                        onClick={() => {
                          setSelectedValueStatus("مشرف");
                        }}
                      >
                        مشرف
                      </Dropdown.Item>
                      <Dropdown.Item
                        onClick={() => setSelectedValueStatus("محاسب")}
                      >
                        محاسب
                      </Dropdown.Item>
                      <Dropdown.Item
                        onClick={() => setSelectedValueStatus("مسوق")}
                      >
                        مسوق
                      </Dropdown.Item>
                    </Dropdown>
