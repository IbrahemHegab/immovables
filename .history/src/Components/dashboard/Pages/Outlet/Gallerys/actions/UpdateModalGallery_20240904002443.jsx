...
const UpdateModalGallery = () => {
  ...
  const initstate = {
    ...
    status: UpdateGalleryModel.data?.status ? "true" : "false",
    show: UpdateGalleryModel.data?.show ? "true" : "false",
    driver: UpdateGalleryModel.data?.driver ? "true" : "false",

    maid: UpdateGalleryModel.data?.maid ? "true" : "false",
    elevator: UpdateGalleryModel.data?.elevator ? "true" : "false",
    warehouse:
