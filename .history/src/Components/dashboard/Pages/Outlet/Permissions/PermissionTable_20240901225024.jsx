...
const PermissionTable = () => {
  ...
  const [customerState, setCustomer] = useState(customer.data);
  const [employeesState, setEmployees] = useState(employees.data);
  console.log(customerState, employeesState);
  const dispatch = useDispatch()
  return (
