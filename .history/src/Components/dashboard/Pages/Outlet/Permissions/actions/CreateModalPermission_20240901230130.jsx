        ...
        <div className="grid grid-flow-row-dense lg:grid-cols-3 grid-cols-1 grid-rows-1 gap-3">
          ...
          <div>
            <div className="mb-2 flex justify-around ">
              ...
              <Label htmlFor="large" value="العملاء" color={"warning"} className="bg-yellow-900 p-2 cursor-pointer rounded-xl"/>
              <Label htmlFor="large" value="الموظفين" color={"warning"} className="bg-yellow-900 p-2 cursor-pointer rounded-xl"/>
            </div>
