        ...
        <div className="grid grid-flow-row-dense lg:grid-cols-3 grid-cols-1 grid-rows-1 gap-3">
          ...
          <div>
            <div className="mb-2 flex justify-around ">
              ...
              <Label htmlFor="large" value="العملاء"  className="bg-yellow-600 text-gray-50 p-2 cursor-pointer rounded-xl hover:bg-yellow-500 checked:"/> 
              <Label htmlFor="large" value="الموظفين"  className="bg-yellow-600 text-gray-50 p-2 cursor-pointer rounded-xl hover:bg-yellow-500 checked:"/> 
            </div>
