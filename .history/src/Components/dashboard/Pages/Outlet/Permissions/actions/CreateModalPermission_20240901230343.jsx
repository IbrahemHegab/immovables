        ...
        <div className="grid grid-flow-row-dense lg:grid-cols-3 grid-cols-1 grid-rows-1 gap-3">
          ...
          <div>
            <div className="mb-2 flex justify-around ">
              ...
              <Label htmlFor="large" value="العملاء"  className="bg-yellow-600 text-gray-50  cursor-pointer rounded-xl hover:bg-yellow-500"/> 
              <Label htmlFor="large" value="الموظفين"  className="bg-yellow-600 text-gray-50  cursor-pointer rounded-xl hover:bg-yellow-500"/> 
            </div>
