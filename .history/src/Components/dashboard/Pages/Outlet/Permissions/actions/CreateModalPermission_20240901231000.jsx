import { Button, Modal, Label, TextInput, Dropdown,Radio } from "flowbite-react";
  ...
  return (
    ...
    <Modal show={PermissionModel}>
      ...
      <Modal.Body>
        ...
        <Radio id="employees" name="employees" value="employees" defaultChecked />
        <Label htmlFor="united-state">موظف</Label>
      </div>
      <div className="flex items-center gap-2">
