...
const initialState = {
  ...
  GalleryApartmentModel: { status: false, data: null },
...
const SharedModel = createSlice({
  ...
  reducers: {
    ...
    setOpenApertmentGalleryModel(state, action) {
      state.GalleryApartmentModel = action.payload;
    },
