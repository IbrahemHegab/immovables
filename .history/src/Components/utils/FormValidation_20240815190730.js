...
export const galleryFormValid = Yup.object().shape({
    ...
    maid: Yup.string().required("الاختيار مطلوب"),
    elevator: Yup.string().required("الاختيار مطلوب"),
    driver: Yup.string().required("الاختيار مطلوب"),
    warehouse: Yup.string().required("الاختيار مطلوب"),
    kind: Yup.string().required("الاختيار مطلوب"),
