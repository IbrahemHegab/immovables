...
import Home from "./Components/dashboard/Pages/Outlet/Home.jsx";
import GalleryApartment from "./Components/dashboard/Pages/Outlet/Gallerys/GalleryApartment.jsx";
import MyTasksTable from "./Components/dashboard/Pages/Outlet/Employees/MyTasksTable.jsx";
import Cart from "./Components/contents/cart/Cart.jsx";
const Route = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      // },
      {
        path: "employees/myTask",
        element: <MyTasksTable />,
      },
    ],
  },
]);
